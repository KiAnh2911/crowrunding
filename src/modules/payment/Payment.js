...
const Payment = () => {
  return (
    <div className="flex gap-x-[30px]">
      <div className="w-[132px] h-[102px] shadow-1 rounded-2xl bg-white flex flex-col justify-center items-center py-6 px-10 border border-primary relative cursor-pointer">
      ...
      <div className="w-[132px] h-[102px] shadow-1 rounded-2xl bg-white flex flex-col justify-center items-center py-6 px-10 cursor-pointer">
