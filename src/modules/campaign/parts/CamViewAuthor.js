  ...
  return (
    <div className="flex items-center gap-x-5 mb-8">
      <div className="w-[60px] h-[60px]">
        <img
          src="https://images.unsplash.com/photo-1678774267521-af5ea575d910?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHx0b3BpYy1mZWVkfDJ8RnpvM3p1T0hONnd8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=60"
          alt="author-view"
      ...
      <div className="flex-1 flex flex-col">
        <div className="flex gap-x-4 items-center">
          <h3 className="text-text1 text-[18px] font-medium leading-[30px]">
            Saiful Islam
          </h3>
        ...
        <div className="flex gap-x-3 items-center text-sm text-text3">
          <strong className=" text-primary opacity-80">02 Campaign</strong>
